                ...
                <thead>
                  <tr className="border-b border-slate-200 dark:border-slate-800">
                    ...
                    <th className="th text-right">
                      ยอดยกมา <span className="font-normal text-indigo-500 normal-case">แก้ได้</span>
                    </th>
                    ...
                    return (
                      <tr key={r.id} className="group border-b border-slate-100 last:border-0 dark:border-slate-800/60">
                        ...
                        <td className="px-2 py-1 text-right">
                          {/* ตัวเลขเองคือปุ่มแก้ — เส้นประใต้ตัวเลข + ดินสอ บอกว่าแตะได้ */}
                          <button
                            onClick={() => setEditing(r)}
                            title="แตะเพื่อแก้ยอดยกมาต้นปี"
                            className="num inline-flex cursor-pointer items-center gap-1.5 rounded-lg px-2 py-1.5 text-slate-600 underline decoration-slate-300 decoration-dashed underline-offset-4 transition hover:bg-indigo-50 hover:text-indigo-700 active:scale-95 dark:text-slate-300 dark:decoration-slate-600 dark:hover:bg-indigo-950/40 dark:hover:text-indigo-300"
                          >
                            {fmt0(r.opening)}
