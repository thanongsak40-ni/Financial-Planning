...
| หน้า | ทำอะไรได้ |
|---|---|
| **ภาพรวม** | KPI, กราฟรายเดือน, เส้นเงินสะสม, แผน vs จริง, สัดส่วน, คำเตือนอัตโนมัติ |
| **เส้นทางสู่เป้า** | ตั้งเป้า "อายุ X ต้องมี Y บาท" แล้วดูว่าไปถึงไหม ต้องออมเดือนละเท่าไร |
| **บันทึกจริง** | ตารางแบบ Excel 12 เดือน · เลื่อนด้วยลูกศร · สถานะรายช่อง · หมายเหตุรายเดือน |
| **แผนการเงิน** | ตารางแบบเดียวกัน ใช้เป็นเส้นฐานเปรียบเทียบ |
| **แผน vs จริง** | เทียบรายหมวดและรายรายการ เรียงตามที่ห่างจากแผนมากที่สุด |
